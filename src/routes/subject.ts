...
import { getSubjectsFiltered, getUsersFiltered } from "../services/subject";
...
router.get("/user/:idUser", getUsersFiltered);
router.get("/subject/:idSubject", getSubjectsFiltered);
